    ...
    return (
        <div className={styles.container}>
            ...
            <header className={styles.header}>
                {home ? (
                    <>
                        <img src='/images/pc.jpg' className={`${styles.headerHomeImage} ${utilStyles.borderCircle}`} alt={name} />
                    ...
                    <>
                        <Link href='/'>
                            <a>
                                <img src='/images/pc.jpg' className={`${styles.headerImage} ${utilStyles.borderCircle}`} alt={name} />
                            </a>
                        </Link>
